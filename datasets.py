...
class IntentSlotDataset(Dataset):
    def __init__(self, raw_data, intent_labels, slot_labels, tokenizer, word_tokenizer=None, **kwargs):
        super().__init__()
        ...
        self.word_tokenizer = word_tokenizer  # 添加外部词分词器
