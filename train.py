...
def train(args):
    ...
    custom_tokens = ["厨房", "空调", "卧室", "冰箱", "阀门", "窗帘"]  # 你的领域关键词
...
if __name__ == '__main__':
    ...
    # data parameters
    parser.add_argument("--train_data_path", type=str, default='data/SMP2019/train.json',  help="training data path")
    parser.add_argument("--test_data_path", type=str, default='data/SMP2019/test.json',  help="testing data path")
    ...
    # training parameters
    parser.add_argument("--save_dir", type=str, default='result/model',  help="directory to save the model")
